...
echo $form->field($generator, 'tableName')->widget(AutoComplete::class, [
    'options' => ['table_prefix' => $generator->getTablePrefix()],
    'source' => $generator->getTableNameAutoComplete(true)
]);
echo $form->field($generator, 'modelClass');
echo $form->field($generator, 'ns')->widget(AutoComplete::class, [
    'source' => $generator->getNsAutoComplete(),
    'clientOptions' => ['select' => $onSelect]
]);
echo $form->field($generator, 'baseClass')->widget(AutoComplete::class, [
...
echo $form->field($generator, 'queryNs')->widget(AutoComplete::class, [
    'source' => $generator->getQueryNsAutoComplete()
]);
echo $form->field($generator, 'queryClass');
echo $form->field($generator, 'queryBaseClass')->widget(AutoComplete::class, [
